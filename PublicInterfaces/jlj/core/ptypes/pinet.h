...
#ifdef _MSC_VER
// 20090311, Guido Schmidt : 64bit problem
#pragma pack(push)
#endif
...
#if (defined(__DARWIN__) && !defined(_SOCKLEN_T)) || defined(_WIN32) || defined(__hpux)
...
// 20090311, GSM : can be very useful
...
// 20090311, GSM : can be very useful, handle is of type pintptr
...
{
public:
// 20090311, GSM : more compatible with AIX and 64bit
    pintptr handle;
