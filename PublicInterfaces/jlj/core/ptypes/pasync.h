...
#ifdef _WIN32
// 20090311, GSM : should be unsigned int
...
#if defined(_WIN32) || defined(__DARWIN__) || defined(__bsdi__)
...
protected:
#ifdef _WIN32
// 20090311, GSM : should use pthread_id_t
    pthread_id_t id;
#endif
    pthread_t  handle;
    int  autofree;
...
// 20090311, GSM : why limit yourself, we use it with 100000s of entries
const int DEF_QUEUE_LIMIT = INT_MAX;
