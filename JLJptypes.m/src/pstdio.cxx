...
{
#ifdef _WIN32
    pin.set_syshandle((pintptr) DuplicateSysHandle(STD_INPUT_HANDLE));
    pout.set_syshandle((pintptr) DuplicateSysHandle(STD_OUTPUT_HANDLE));
    perr.set_syshandle((pintptr) DuplicateSysHandle(STD_ERROR_HANDLE));
#else
