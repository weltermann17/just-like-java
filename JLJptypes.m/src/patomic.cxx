...
int pexchange(int* target, int value)
{
	volatile int oldvalue = *target;
	compare_and_swap(target, (int*) &oldvalue, value);
	return oldvalue;
}

void* pexchange(void** target, void* value)
{
	volatile void* oldvalue = *target;
#if defined(PLATFORM_64)
	compare_and_swaplp((atomic_l) target, (long*) &oldvalue, (long) value);
#else
	compare_and_swap((int*) target, (int*) &oldvalue, (int) value);
#endif	
...
int pincrement(int* target)
{
	return 1 + fetch_and_add(target, 1);
}
